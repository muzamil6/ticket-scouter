...
import {
    TextInput, View, TouchableOpacity, Text, KeyboardAvoidingView, Keyboard, TouchableWithoutFeedback, StatusBar, SafeAreaView,
                            ...
                            <View style={styles.main}>
                                <View style={styles.inputContainer}>
                                    ...
                                    <Button
                                        title="Save Changes"
                                        disabled
                                        buttonStyle={{ borderRadius: 50, paddingVertical: 14,backgroundColor:"#ecf1f6",color:'gray'}}
                                    />
                                </View>
                            </View>
                        </View>
