          ...
          <View style={{margin: 20}}>
            ...
            <View style={{marginTop: 20}}>
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.ticketHead,
                  {borderColor: selectedTicket == 'regular' ? 'blue' : 'gray'},
                ]}
                ...
                <View
                  style={[
                    ...
                    {
                      borderRightColor:
                        selectedTicket == 'regular' ? 'blue' : 'gray',
                    },
                  ]}>
                  <View
                    style={{
                    ...
                    <Icon
                      ...
                      size={25}
                      color={selectedTicket == 'regular' ? 'blue' : 'gray'}
                    />
                  </View>
                  <Text
                    style={{
              ...
              <TouchableOpacity
                ...
                style={[
                  styles.ticketHead,
                  {borderColor: selectedTicket == 'vvip' ? 'blue' : 'gray'},
                ]}
                ...
                <View
                  ...
                  <View
                    ...
                    <Icon
                      name="ticket-confirmation-outline"
                      size={25}
                      color={selectedTicket == 'vvip' ? 'blue' : 'gray'}
                    />
                  </View>
                  <Text
                    style={{
